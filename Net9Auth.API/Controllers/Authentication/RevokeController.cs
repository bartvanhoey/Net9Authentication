...
[Route("api/account")]
[ApiController]
public class RevokeController(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, IHostEnvironment environment, ILogger<RevokeController> logger, IConfiguration configuration)
